...
# -*- coding: utf-8 -*-
"""
Created on Mon May 27 17:08:41 2019
...
# Any of the above are possible. correct
#  Submit You have used 1 of 1 attempt Some problems have options such as save, reset, hints, or show answer. These options follow the Submit button.
# Problem 1-3
# 1/1 point (graded)
...
# points linearly from 1900 to 2000 and a red line fitted to the points that dips to 0 from x=2000 to x=2050 
# 
# overfitting correct
# underfitting
...
# Problem 1-6
# 1/1 point (graded)
# If the 𝑅2 of a model produced using linear regression is 0.7, the model accounts for 70% of the variance in the observations.
# 
# True correct
# False
#  Submit You have used 1 of 1 attempt Some problems have options such as save, reset, hints, or show answer. These options follow the Submit button.
...
# incorrect (select both CTL and SE)
# Submit You have used 1 of 1 attempt Some problems have options such as save, reset, hints, or show answer. These options follow the Submit button.
# Problem 1-9
